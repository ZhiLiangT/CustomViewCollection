...
public class LoveLayout  extends RelativeLayout {
    ...
    private void initDrawable() {
        mRed = getResources().getDrawable(R.mipmap.hart_red);
        mYellow = getResources().getDrawable(R.mipmap.hart_yellow);
        mBlue = getResources().getDrawable(R.mipmap.hart_green);
